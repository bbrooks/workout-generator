...
export const sounds = {
    ...
    excercises: {
        [exerciseCategories.cardio]: [
            ...
            process.env.PUBLIC_URL + '/sounds/cardio/high-jump.m4a',
       ...
       [exerciseCategories.upperBody]: [
            ...
            process.env.PUBLIC_URL + '/sounds/upper-body/pushups-row.m4a',
            process.env.PUBLIC_URL + '/sounds/upper-body/pushups-triangle.m4a',
            process.env.PUBLIC_URL + '/sounds/upper-body/pushups-wide.m4a',
        ...
        [exerciseCategories.lowerBody]: [
            ...
            process.env.PUBLIC_URL + '/sounds/lower-body/reverse-lunge-core-twist.m4a',
    ...
    transitions: {
        ...
        silence60: process.env.PUBLIC_URL +'/sounds/transitions/silence-60.mp3',
